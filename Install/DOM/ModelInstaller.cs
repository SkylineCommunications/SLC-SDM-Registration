		...
		private void InstallModel(DomHelper helper)
		{
			var modelProperties = new SectionDefinitionBuilder()
				...
				.AddFieldDescriptor(new FieldDescriptorBuilder()
					...
					.WithType(typeof(string))
					.WithIsOptional(true)
					.WithTooltip("The endpoint to inreract with the model to create a visualization using the REST API."))
				.AddFieldDescriptor(new FieldDescriptorBuilder()
					...
					.WithType(typeof(string))
					.WithIsOptional(true)
					.WithTooltip("The endpoint to inreract with the model to update a visualization using the REST API."))
				.AddFieldDescriptor(new FieldDescriptorBuilder()
					...
					.WithType(typeof(string))
					.WithIsOptional(true)
					.WithTooltip("The endpoint to inreract with the model to delete a visualization using the REST API."))
